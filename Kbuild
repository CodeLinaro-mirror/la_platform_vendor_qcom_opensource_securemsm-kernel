...
ifneq (, $(filter y, $(CONFIG_QTI_QUIN_GVM) $(CONFIG_ARCH_KHAJE) $(CONFIG_ARCH_SA8155) $(CONFIG_ARCH_BLAIR) $(CONFIG_ARCH_SA6155) $(CONFIG_ARCH_MONACO) $(CONFIG_ARCH_SM6150) $(CONFIG_ARCH_LAHAINA) $(CONFIG_ARCH_YUPIK)))
